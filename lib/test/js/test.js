...
describe('Broadcast Smses', function() {
  ...
  it('should be able to create a broadcast sms', function(done) {
    sms = teamsnap.createBroadcastSms();
    sms.teamId = team.id;
    sms.memberId = sender.id;
    sms.body = "Hello world";
    sms.recipientIds = [recipient.id];
    return teamsnap.saveBroadcastSms(sms, function(err, result) {
      expect(err).to.be["null"];
  ...
  it('should be able to load all broadcast smses for a team', function(done) {
    var sms2;
    ...
    return teamsnap.saveBroadcastSms(sms2, function(err, result) {
      expect(err).to.be["null"];
      return teamsnap.loadBroadcastSmses({
        teamId: team.id
      }, function(err, result) {
        expect(err).to.be["null"];
        result.should.be.an('array');
  ...
  it('should be able to load a single broadcast sms', function(done) {
    return teamsnap.loadBroadcastSmses(sms.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      result.should.have.property('length', 1);
  ...
  return it('should be able to delete a forum topic', function(done) {
    return teamsnap.deleteBroadcastSms(sms, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/chai", function(exports, require, module) {
;(function(){
...
require.register("test/divisionLocations", function(exports, require, module) {
describe('DivisionLocations', function() {
  return it('should be able to load all division locations for team', function(done) {
    return teamsnap.loadDivisionLocations(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/divisionMembers", function(exports, require, module) {
describe('DivisionMembers', function() {
  var member;
  member = null;
  return it('should be able to load all division members for team', function(done) {
    return teamsnap.loadDivisionMembers(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/divisionTeamStandings", function(exports, require, module) {
describe('Division Team Standings', function() {
  return it('should be able to load division team standings', function(done) {
    return teamsnap.loadDivisionTeamStandings(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
describe('Divisions', function() {
  ...
  it('should be able to create a new division', function(done) {
    return newDivision = teamsnap.createDivision({
      name: 'New Test Team',
      sportId: 1,
  ...
  it('should be able to load all divisions', function(done) {
    teamsnap.loadDivisions(function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  ...
  it('should be able to load a division', function(done) {
    return teamsnap.loadDivision(newDivision.id, function(err, result) {
      expect(err).to.be["null"];
      return result.should.be.an('array');
    });
  });
  return it('should be able to delete a division', function(done) {
...
require.register("test/forumPosts", function(exports, require, module) {
describe('Forum Posts', function() {
  var member, post, topic;
  topic = null;
  post = null;
  member = null;
  before(function(done) {
    ...
    return teamsnap.saveForumTopic(topic, function(err, result) {
      expect(err).to.be["null"];
  ...
  it('should be able to create a forum post', function(done) {
    post = teamsnap.createForumPost();
    post.forumTopicId = topic.id;
    post.memberId = member.id;
    post.message = "What a post";
    return teamsnap.saveForumPost(post, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'forumPost');
      return done();
    });
  });
  it('should be able to load all forum posts for team', function(done) {
    return teamsnap.loadForumPosts({
      teamId: team.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
  ...
  return it('should be able to delete a forum post', function(done) {
    return teamsnap.deleteForumPost(post, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/forumSubscriptions", function(exports, require, module) {
describe('Forum Subscriptions', function() {
  return it('should be able to load all forum subscriptions for team', function(done) {
    return teamsnap.loadForumSubscriptions({
      teamId: team.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
...
require.register("test/forumTopics", function(exports, require, module) {
describe('Forum Topics', function() {
  var topic;
  topic = null;
  it('should be able to create a forum topic', function(done) {
    topic = teamsnap.createForumTopic();
    topic.teamId = team.id;
    topic.title = "What a topic";
    return teamsnap.saveForumTopic(topic, function(err, result) {
  ...
  it('should be able to load all forum topics for team', function(done) {
    return teamsnap.loadForumTopics({
      teamId: team.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
  ...
  return it('should be able to delete a forum topic', function(done) {
    return teamsnap.deleteForumTopic(topic, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
var apiInput, authButton, authInput, authSection, clientId, clientIdInput, collections, id, redirect, scopes, url, whenAuthFailed, whenAuthed;
...
clientIdInput.addEventListener('change', function() {
  ...
  return localStorage.setItem('teamsnap.clientId', clientId);
});
...
whenAuthFailed = function(err) {
  return authSection.style.display = '';
};

authButton.addEventListener('click', function() {
  authSection.style.display = 'none';
  return teamsnap.startBrowserAuth(redirect, scopes).then(teamsnap.loadCollections).then(whenAuthed, whenAuthFailed);
});
...
;require.register("test/leagueCustomData", function(exports, require, module) {
describe('League Custom Data', function() {
  return it('should be able to load all league custom data', function(done) {
    return teamsnap.loadLeagueCustomData({
      teamId: team.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
...
require.register("test/leagueCustomFields", function(exports, require, module) {
describe('League Custom Fields', function() {
  return it('should be able to load all league custom fields for team', function(done) {
    return teamsnap.loadLeagueCustomFields(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/leagueRegistrantDocuments", function(exports, require, module) {
describe('League Registrant Documents', function() {
  var member;
  member = null;
  before(function(done) {
    member = teamsnap.createMember();
  ...
  it('should be able to load all registrant documents for team', function(done) {
    return teamsnap.loadLeagueRegistrantDocuments(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  return it('should be able to load a single registrant`s documents', function(done) {
    return teamsnap.loadLeagueRegistrantDocuments({
      memberId: member.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
...
describe('Member Links', function() {
  var link, member;
  member = null;
  link = null;
  before(function(done) {
...
require.register("test/memberStatistics", function(exports, require, module) {
describe('Member Statistics', function() {
  return it('should be able to load all statistics for member', function(done) {
    return teamsnap.loadMemberStatistics(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
describe('Opponent Results', function() {
  ...
  before(function(done) {
    ...
    return teamsnap.saveOpponent(opponent1, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  before(function(done) {
    ...
    return teamsnap.saveOpponent(opponent2, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteOpponent(opponent1, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteOpponent(opponent2, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  it('should be able to load results for all team opponents', function(done) {
    return teamsnap.loadMe().then(function(me) {
      return teamsnap.loadOpponentsResults({
        teamId: team.id
      }, function(err, result) {
        expect(err).to.be["null"];
        result.should.be.an('array');
  ...
  return it('should be able to load results for single opponent', function(done) {
    return teamsnap.loadOpponentResults(opponent1.id, function(err, result) {
      expect(err).to.be["null"];
...
require.register("test/statisticData", function(exports, require, module) {
describe('Statistic Data', function() {
  var bulkStatistic, bulkStatisticDatum, event, location, member, statistic, statisticDatum;
  member = null;
  location = null;
  event = null;
  statistic = null;
  ...
  before(function(done) {
    ...
    return teamsnap.saveEvent(event, function(err, result) {
      expect(err).to.be["null"];
  ...
  before(function(done) {
    ...
    return teamsnap.saveStatistic(statistic, function(err, result) {
      expect(err).to.be["null"];
  ...
  before(function(done) {
    ...
    return teamsnap.saveStatistic(bulkStatistic, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'statistic');
      return done();
    });
  ...
  after(function(done) {
    return teamsnap.deleteStatistic(statistic, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteStatistic(bulkStatistic, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteEvent(event, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteLocation(location, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  it('should be able to create a member statistic datum', function(done) {
    ...
    return teamsnap.saveStatisticDatum(statisticDatum, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'statisticDatum');
      return done();
    });
  });
  it('should be able to bulk save member statistic data', function(done) {
    var clonedTemplate, templates;
    ...
    templates = [];
    clonedTemplate = JSON.parse(JSON.stringify(teamsnap.collections.statisticData.template));
    clonedTemplate.forEach(function(field) {
      var camelizedFieldName;
      camelizedFieldName = field.name.replace(/(\_\w)/g, function(m) {
        return m[1].toUpperCase();
      });
      return field.value = statisticDatum[camelizedFieldName];
    });
    templates.push({
      data: clonedTemplate
    });
    return teamsnap.bulkSaveStatisticData(JSON.stringify(templates), function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to load all team statistic data', function(done) {
    return teamsnap.loadStatisticData(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to delete a statistic datum', function(done) {
    return teamsnap.deleteStatisticDatum(statisticDatum, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  return it('should be able to bulk delete statistic data', function(done) {
    return teamsnap.bulkDeleteStatisticData(member, event, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/statisticGroups", function(exports, require, module) {
describe('Statistic Groups', function() {
  var statisticGroup;
  statisticGroup = null;
  it('should be able to load all team statistic groups', function(done) {
    return teamsnap.loadStatisticGroups(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to create a team statistic group', function(done) {
    ...
    return teamsnap.saveStatisticGroup(statisticGroup, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'statisticGroup');
      return done();
    });
  });
  return it('should be able to delete a statistic group', function(done) {
    return teamsnap.deleteStatisticGroup(statisticGroup, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/statistics", function(exports, require, module) {
describe('Statistics', function() {
  var statistic;
  statistic = null;
  it('should be able to load all team statistics', function(done) {
    return teamsnap.loadStatistics(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to create a team statistic', function(done) {
    statistic = teamsnap.createStatistic();
    statistic.teamId = team.id;
    statistic.name = 'Test Statistic';
    statistic.acronym = 'TST';
  ...
  return it('should be able to delete a statistic', function(done) {
    return teamsnap.deleteStatistic(statistic, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
...
require.register("test/teamResults", function(exports, require, module) {
describe('Team Results', function() {
  it('should be able to load results for teams', function(done) {
    return teamsnap.loadMe().then(function(me) {
      return teamsnap.loadTeamsResults({
        userId: me.id
      }, function(err, result) {
        expect(err).to.be["null"];
        result.should.be.an('array');
  ...
  return it('should be able to load team results', function(done) {
    return teamsnap.loadTeamResults(team.id, function(err, result) {
      expect(err).to.be["null"];
...
require.register("test/teamStatistics", function(exports, require, module) {
describe('Team Statistics', function() {
  return it('should be able to load all statistics for team', function(done) {
    return teamsnap.loadTeamStatistics(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
