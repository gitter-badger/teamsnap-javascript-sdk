...
exports.loadBroadcastSmses = function(params, callback) {
  if (this.isId(params)) {
    ...
    throw new TSArgsError('teamsnap.loadBroadcastSmses', 'must provide an id or query parameters');
  }
  return this.loadItems('broadcastSms', params, callback);
};

exports.createBroadcastSms = function(data) {
  return this.createItem(data, {
    type: 'broadcastSms'
  });
};

exports.saveBroadcastSms = function(broadcastSms, callback) {
  var ref;
  if (!broadcastSms) {
    throw new TSArgsError('teamsnap.saveBroadcastSms', "`broadcastSms` must be provided");
  }
  if (!this.isItem(broadcastSms, 'broadcastSms')) {
    throw new TSArgsError('teamsnap.saveBroadcastSms', "`type` must be 'broadcastSms'");
  }
  if (!broadcastSms.teamId) {
    return this.reject('You must provide a team id.', 'teamId', callback);
  }
  if (!broadcastSms.memberId) {
    return this.reject('You must provide a member id.', 'memberId', callback);
  }
  if (!((ref = broadcastSms.body) != null ? ref.trim() : void 0)) {
    return this.reject('You must provide the text alert body.', 'body', callback);
  }
  return this.saveItem(broadcastSms, callback);
};

exports.deleteBroadcastSms = function(broadcastSms, callback) {
  if (!broadcastSms) {
    throw new TSArgsError('teamsnap.deleteBroadcastSms', '`broadcastSms` must be provided');
  }
  return this.deleteItem(broadcastSms, callback);
};
...
require.register("collections/divisions", function(exports, require, module) {
...
exports.createDivision = function(division) {
  return this.createItem(data, {
    type: 'division',
    name: ''
  });
...
exports.loadForumPosts = function(params, callback) {
  if (this.isId(params)) {
    ...
    throw new TSArgsError('teamsnap.loadForumPosts', 'must provide an id or query parameters');
  }
...
exports.loadForumSubscriptions = function(params, callback) {
  if (this.isId(params)) {
    ...
    throw new TSArgsError('teamsnap.loadForumSubscriptions', 'must provide an id or query parameters');
  }
...
exports.loadForumTopics = function(params, callback) {
  if (this.isId(params)) {
    ...
    throw new TSArgsError('teamsnap.loadForumTopics', 'must provide an id or query parameters');
  }
...
exports.reorderStatisticGroups = function(teamId, statisticGroupIds, callback) {
  ...
  if (!(statisticGroupIds && typeof statisticGroupIds === 'object')) {
...
exports.reorderStatistics = function(teamId, statisticIds, callback) {
  ...
  if (!(statisticIds && typeof statisticIds === 'object')) {
...
modifySDK = function(sdk) {
  ...
  wrapMethod(sdk, 'bulkDeleteStatisticData', function(bulkDeleteStatisticData) {
    return function(member, event, callback) {
      ...
      linking.unlinkItems(toRemove, lookup);
      return bulkDeleteStatisticData.call(this, member, event).fail(function(err) {
        linking.linkItems(toRemove, lookup);
        return err;
      }).callback(callback);
    };
